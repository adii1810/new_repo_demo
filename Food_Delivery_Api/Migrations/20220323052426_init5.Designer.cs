...
namespace Food_Delivery_Api.Migrations
{
    ...
    [Migration("20220323052426_init5")]
    partial class init5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Order", b =>
                {
                    ...
                    b.Property<int?>("UserDataUser_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Order", b =>
                {
                    b.HasOne("DataAccessLayer.User_Data", "UserData")
                        .WithMany("Orders")
                        .HasForeignKey("UserDataUser_Id");

                    b.HasOne("DataAccessLayer.Valet", "Valet")
                        .WithMany("Orders")
                        .HasForeignKey("Valet_Id");
                });
