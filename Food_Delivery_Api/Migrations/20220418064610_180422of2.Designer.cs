...
namespace Food_Delivery_Api.Migrations
{
    ...
    [Migration("20220418064610_180422of2")]
    partial class _180422of2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.tempOrder", b =>
                {
                    b.Property<int>("Order_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccessLayer.tempOrderDetails", b =>
                {
                    b.HasOne("DataAccessLayer.tempOrder", "Order")
                        .WithMany("Order_Details")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
