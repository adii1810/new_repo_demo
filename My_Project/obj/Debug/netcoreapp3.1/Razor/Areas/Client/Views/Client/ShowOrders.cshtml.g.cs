#pragma checksum "E:\AdityaBackup\Demo\Demo_Project1\new_repo_demo\My_Project\Areas\Client\Views\Client\ShowOrders.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d8860cd19e6cfa5ed0fb0957284ac8da73527960"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d8860cd19e6cfa5ed0fb0957284ac8da73527960", @"/Areas/Client/Views/Client/ShowOrders.cshtml")]
    ...
    <script>
        ...
        const showUp = (status, ordid) => {
            ...
            if (status == 0) {
                ...
                $('#step-2_' + ordid).removeClass('is-active');
                $('#step-3_' +");
                WriteLiteral(@" ordid).removeClass('is-active');
                $('#step-4_' + ordid).removeClass('is-active');
            }
            else if (status == 5) {
                $('#step-5_' + ordid).removeClass('is-active');
