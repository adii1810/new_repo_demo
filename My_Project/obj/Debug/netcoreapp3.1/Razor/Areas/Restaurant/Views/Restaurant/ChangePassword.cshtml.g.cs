#pragma checksum "E:\AdityaBackup\Demo\Demo_Project1\new_repo_demo\My_Project\Areas\Restaurant\Views\Restaurant\ChangePassword.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7dee961307bb649198a1a01bfb3248d413ddedac"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7dee961307bb649198a1a01bfb3248d413ddedac", @"/Areas/Restaurant/Views/Restaurant/ChangePassword.cshtml")]
...
<div class=""container "">
    ...
    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7dee961307bb649198a1a01bfb3248d413ddedac5581", async() => {
                WriteLiteral(@"
        <div class=""row  d-flex justify-content-center"">
            <div class=""col-md-4"">
                ...
                <div class=""form-group"">
                    ...
                    <button type=""button"" disabled class=""btn btn-success btn-block"" id=""send"">
                        Send
                    </button>
 ");
                WriteLiteral(@"               </div>
...
<script>
    ...
    $('#send').click(() => {
        $('#send').html(`<i class=""fa fa-spinner fa-spin""></i> Loading`);
        ...
        $.ajax({
            ...
            WriteLiteral(@".fire({
                        animation: true,
                        title: ""Security code has been sended to your registered email!!!""
                    });
                    $('#prepassValidator').html("""");
                    $('#send').html(`send`);
                    $(""#code"").keyup(() => {
    ...
    //    $.ajax({
    //        url:loc");
            WriteLiteral("ation2+\"UpdatePassword\"\r\n    //    })\r\n    //})\r\n\r\n</script>");
        }
